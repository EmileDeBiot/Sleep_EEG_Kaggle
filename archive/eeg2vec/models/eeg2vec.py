...
class EEG2Vec(nn.Module):
    def __init__(self, conv_sizes, kernel_sizes, d_model, nhead, num_encoder_layers, dim_feedforward, dropout = 0.1):
        super(EEG2Vec, self).__init__()
        self.cnn_encoder = CNNEncoder(conv_sizes, kernel_sizes)
