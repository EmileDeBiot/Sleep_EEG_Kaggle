...
class EEG2Vec(nn.Module):
    def __init__(self, d_model, nhead, num_encoder_layers, dim_feedforward, conv_size, out_size, kernel_size_1, kernel_size_2,  dropout=0.1):
        super(EEG2Vec, self).__init__()
        self.cnn_encoder = CNNEncoder(conv_size, out_size, kernel_size_1, kernel_size_2)
